                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Link
                                href={auth?.user ? '/author/posts/create' : '/login'}
                                className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-bold bg-sky-500/10 text-sky-600 dark:text-sky-400 border border-sky-500/20 hover:bg-sky-500/20 transition"
                            >
                            ...
                            {auth?.user ? (
                                <div className="relative">
                                    <button
                                        ...
                                        className="flex items-center gap-2 p-1 rounded-xl hover:bg-slate-100 dark:hover:bg-white/[0.08] transition"
                                    >
                                        <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-sky-500 to-indigo-600 flex items-center justify-center text-white text-xs font-bold uppercase shadow-sm">
                                    ...
                                    {profileDropdownOpen && (
                                        <div
                                            className="absolute right-0 mt-2 w-56 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-2xl p-2 z-50 text-xs"
                                            onClick={() => setProfileDropdownOpen(false)}
                                        >
                                            <div className="px-3 py-2 border-b border-slate-100 dark:border-white/[0.08] mb-1">
                                                <p className="font-bold text-slate-900 dark:text-white truncate">{auth.user.name}</p>
                                                <p className="text-[11px] text-slate-400 truncate">{auth.user.email}</p>
                                            </div>

                                            <Link
                                                href="/author/dashboard"
                                                className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/[0.05] font-semibold transition"
                                            >
                                            ...
                                            {auth.user.is_admin && (
                                                <a
                                                    href="/admin"
                                                    className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-500/10 font-bold transition"
                                                >
                                            ...
                                            <Link
                                                href="/profile"
                                                className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/[0.05] transition"
                                            >
                                            ...
                                            <div className="pt-1 mt-1 border-t border-slate-100 dark:border-white/[0.08]">
                                                <Link
                                                    ...
                                                    method="post"
                                                    as="button"
                                                    className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 font-bold transition text-left"
                                                >
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {auth?.user ? (
                            <div className="pt-2 border-t border-slate-200 dark:border-white/10 space-y-1">
                                <Link
                                    href="/author/dashboard"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className="block px-3 py-2 rounded-lg text-sm font-bold text-sky-600 dark:text-sky-400 bg-sky-500/10"
                                >
                                    My Articles & Studio
                                </Link>
                                <Link
                                    href="/author/posts/create"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className="block px-3 py-2 rounded-lg text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/[0.05]"
                                >
                                    Write New Article
                                </Link>
                                {auth.user.is_admin && (
                                    <a
                                        href="/admin"
                                        className="block px-3 py-2 rounded-lg text-sm font-bold text-amber-500 bg-amber-500/10"
                                    >
                                        Admin Console
                                    </a>
                                )}
                                <Link
                                    ...
                                    method="post"
                                    as="button"
                                    className="w-full text-left block px-3 py-2 rounded-lg text-sm font-semibold text-rose-500"
                                >
                                    Sign Out
                                </Link>
                            </div>
                            ...
                            <div className="pt-2 border-t border-slate-200 dark:border-white/10 flex gap-2">
                                <a
                                    href="/login"
                                    className="flex-1 text-center py-2 rounded-xl text-xs font-bold bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white"
                                >
                                    Sign In
                                </a>
                                <a
                                    href="/register"
                                    className="flex-1 text-center py-2 rounded-xl text-xs font-bold bg-sky-500 text-white"
                                >
                                    Register
                                </a>
                            </div>
