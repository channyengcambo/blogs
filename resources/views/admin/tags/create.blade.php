    ...
    <div class="p-6 sm:p-8 max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white dark:bg-dark-800/90 rounded-2xl shadow-sm border border-gray-200/80 dark:border-dark-700 p-6 sm:p-8">
            <div class="mb-6 pb-4 border-b border-gray-100 dark:border-dark-700">
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Create New Tag</h1>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    Add a keyword tag to label blog posts and group related micro-topics.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.tags.store') }}" class="space-y-5">
                ...
                <div class="px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-dark-900 border border-gray-200/80 dark:border-dark-700 text-xs">
                    ...
                    <span class="font-mono text-indigo-500 font-medium ml-1">
                        yourblog.com/tags/<span id="live-slug-text" class="underline decoration-dotted font-bold">new-tag</span>
                    </span>
                </div>
                ...
                <div>
                    <x-bladewind::textarea
                        ...
                        placeholder="Describe what kind of content uses this tag..."
                        rows="4"
